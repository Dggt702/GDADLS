        ...
        <div class="d-flex align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="col-auto col-lg-auto dropdown text-end">
                <a href="#" class="d-flex align-items-center link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="rounded-circle" style="width: 2.5rem; height:2.5rem; background-position:center; background-size:cover; background-image: url(<?php echo FuncionesVista::mostraRutaFotoArbitro($arbitro) ?>)"></div>
                    <strong class="ps-2"><?php echo $arbitro->getNombre()." ". $arbitro->getApellidos()?></strong>
                </a>
